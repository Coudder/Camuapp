...
;
 ...
 public diccitoTotal3564:any;
  ...
  ngOnInit() {
    ...
    getCito(){ /*  DATOS DE GOOGLESHEET INFO GENERAL */
    this._dataService.getcitoData().subscribe(
      ...
      this.metaCito = this.datos.filter((meta:any)=>{
      ...
      this.metacitoPrimera = this.datos.filter((data:any)=>{
      ...
      this.metacitoprimeraTotal = this.metacitoPrimera.length;
       ...
       this.metacitoSegunda = this.datos.filter((data:any)=>{
      ...
      this.metacitoSubsecuente = this.datos.filter((data:any)=>{
      ...
      this.citosinResultado = this.datos.filter((data:any)=> {
      ...
      this.libgEdad = this.datos.filter((data:any)=>{ //libg de 25-34 años
      ...
      this.liagEdad = this.datos.filter((data:any)=>{ //libg de 25-34 años
      ...
      /* INDICADORES DX CITOLOGICO GENERAL */
        ...
        this.metacitoLibg = this.datos.filter((libg:any)=>{
          if(libg.refdxCito == this.dxCitologico.dxcitoLibg  ){
            return libg
          }
        });
        //obtener total libg  patologo
        this.metacitopatoLibg = this.datos.filter((data:any) =>{
        ...
        this.metacitoLiag = this.datos.filter((liag:any)=>{
          if(liag.refdxCito == this.dxCitologico.dxcitoLiag ){
            return liag
          }
        });
        //liag de patologo
        this.metacitopatoLiag = this.datos.filter((data:any)=>{
        ...
        this.metacitoCarcinoma = this.datos.filter((data:any)=>{
          if(data.refdxCito == this.dxCitologico.dxcitoCarcinoma){
            return data
          }
        });
        //carcionomas patologo
        this.metacitopatoCarcinoma = this.datos.filter((data:any)=>{
          if(data.refdxPato == this.dxCitologico.dxpatoCarcinoma){
            return data
          }
        });
        //inadecuadass
        this.metacitoInadecuadas = this.datos.filter((data:any)=>{
        ...
        this.metacitopatoInadecuadas = this.datos.filter((data:any)=>{
          if(data.refdxPato == this.dxCitologico.dxpatoInadecuada){
            return data
          }
        });

        this.metacitoNegativas = this.datos.filter((data:any)=>{
          if(data.refdxCito == this.dxCitologico.dxcitoNegativa){
            return data
          }
        });

        this.metacitopatoNegativas = this.datos.filter((data:any)=>{
          if(data.refdxPato == this.dxCitologico.dxpatoNegativa){
            return data
          }
        });

        this.citoNull = this.datos.filter((data:any)=>{
      ...
      TODO: //indicadores x mes generales 
        ...
        this.ene1vezD3menor25 = this.datos.filter((data:any)=>{
        ...
        this.ene1vezd3d3564 = this.datos.filter((data:any)=>{
        ...
        this.ene1vezd3d3564Total = this.ene1vezd3d3564.length;
         ...
         ////////////////mayores a 64
         this.enemayores64 = this.datos.filter((data:any)=>{
        ...
        this.eneSubs3564Total = this.eneSubs3564.length;
          ...
          this.feb1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.feb1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.febmayores64 = this.datos.filter((data:any)=>{
          ...
          this.mar1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.mar1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.marmayores64 = this.datos.filter((data:any)=>{
          ...
          this.abr1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.abr1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.abrmayores64 = this.datos.filter((data:any)=>{
          ...
          this.may1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.may1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.maymayores64 = this.datos.filter((data:any)=>{
          ...
          this.jun1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.jun1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.junmayores64 = this.datos.filter((data:any)=>{
          ...
          this.jul1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.jul1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.julmayores64 = this.datos.filter((data:any)=>{
          ...
          this.ago1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.ago1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.agomayores64 = this.datos.filter((data:any)=>{
          ...
          this.sep1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.sep1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.sepmayores64 = this.datos.filter((data:any)=>{
          ...
          this.oct1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.oct1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.octmayores64 = this.datos.filter((data:any)=>{
          ...
          this.nov1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.nov1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.novmayores64 = this.datos.filter((data:any)=>{
          ...
          this.dic1vezD3menor25 = this.datos.filter((data:any)=>{
          ...
          this.dic1vezd3d3564 = this.datos.filter((data:any)=>{
           ...
           ////////////////mayores a 64
           this.dicmayores64 = this.datos.filter((data:any)=>{
    ...
    getcitoBack(){ /*DATOS DEL BACKEND */

    this._dataService.getCitologias().subscribe(

      response => {

        if(response.status == 'success')
        {
          this.citologias = response.citologias;
          //console.log( this.citologias);
          this.totalUnidades = Object.keys(this.citologias).length;
      ...
      this._dataService.getUnidades().subscribe(
          ...
          response => {
            if(response.status == 'success')
            {
              ...
              this.totalUnidades = Object.keys(this.unidades).length;
