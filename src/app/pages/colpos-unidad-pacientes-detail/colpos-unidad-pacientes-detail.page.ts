...
@Component({
  selector: 'app-colpos-unidad-pacientes-detail',
  templateUrl: './colpos-unidad-pacientes-detail.page.html',
  styleUrls: ['./colpos-unidad-pacientes-detail.page.scss'],
  providers: [AdminService,DataService]

})
export class ColposUnidadPacientesDetailPage implements OnInit {
