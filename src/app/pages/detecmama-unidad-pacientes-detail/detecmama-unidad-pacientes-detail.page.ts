...
@Component({
  selector: 'app-detecmama-unidad-pacientes-detail',
  templateUrl: './detecmama-unidad-pacientes-detail.page.html',
  styleUrls: ['./detecmama-unidad-pacientes-detail.page.scss'],
  providers: [AdminService,DataService]

})
export class DetecmamaUnidadPacientesDetailPage implements OnInit {
