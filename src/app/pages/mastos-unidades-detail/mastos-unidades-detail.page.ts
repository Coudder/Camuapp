...
@Component({
  selector: 'app-mastos-unidades-detail',
  templateUrl: './mastos-unidades-detail.page.html',
  styleUrls: ['./mastos-unidades-detail.page.scss'],
  providers: [DataService,AdminService]
})
export class MastosUnidadesDetailPage implements OnInit {
      ...
      this._route.params.subscribe(params=> {
        ...
        this._dataService.getUnidadDetail(this.id).subscribe(
          response => {
            ...
            //obtenemos info del paralelo de mastos
