...
@Component({
  selector: 'app-colpos-unidades-detail',
  templateUrl: './colpos-unidades-detail.page.html',
  styleUrls: ['./colpos-unidades-detail.page.scss'],
  providers: [AdminService,DataService]
})
export class ColposUnidadesDetailPage implements OnInit {
  ...
  getcolposunidadData(){
    this._route.params.subscribe(params =>{
      ...
      //getData de la unidad seleccionada
