...
@Component({
  selector: 'app-vphs-unidad-pacientes',
  templateUrl: './vphs-unidad-pacientes.page.html',
  styleUrls: ['./vphs-unidad-pacientes.page.scss'],
  providers: [AdminService, DataService]
})
export class VphsUnidadPacientesPage implements OnInit, ViewWillEnter {
