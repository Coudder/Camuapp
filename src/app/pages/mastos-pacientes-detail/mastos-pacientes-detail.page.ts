...
@Component({
  selector: 'app-mastos-pacientes-detail',
  templateUrl: './mastos-pacientes-detail.page.html',
  styleUrls: ['./mastos-pacientes-detail.page.scss'],
  providers: [AdminService,DataService]
})
export class MastosPacientesDetailPage implements OnInit {
  public title:string;
  public identity;
  public token;
  public id;
