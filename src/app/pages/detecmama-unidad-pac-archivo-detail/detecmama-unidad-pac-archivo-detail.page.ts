...
@Component({
  selector: 'app-detecmama-unidad-pac-archivo-detail',
  templateUrl: './detecmama-unidad-pac-archivo-detail.page.html',
  styleUrls: ['./detecmama-unidad-pac-archivo-detail.page.scss'],
})
export class DetecmamaUnidadPacArchivoDetailPage implements OnInit {
