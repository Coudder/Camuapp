...
@Component({
  selector: 'app-mastos-unidad-pacientes-detail',
  templateUrl: './mastos-unidad-pacientes-detail.page.html',
  styleUrls: ['./mastos-unidad-pacientes-detail.page.scss'],
  providers:[AdminService,DataService]

})
export class MastosUnidadPacientesDetailPage implements OnInit {
