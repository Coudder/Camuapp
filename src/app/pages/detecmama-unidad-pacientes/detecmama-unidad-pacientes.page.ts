...
@Component({
  selector: 'app-detecmama-unidad-pacientes',
  templateUrl: './detecmama-unidad-pacientes.page.html',
  styleUrls: ['./detecmama-unidad-pacientes.page.scss'],
  providers:[AdminService,DataService]

})
export class DetecmamaUnidadPacientesPage implements OnInit {
