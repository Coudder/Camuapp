...
@Component({
  selector: 'app-vphs-unidades-detail',
  templateUrl: './vphs-unidades-detail.page.html',
  styleUrls: ['./vphs-unidades-detail.page.scss'],
})
export class VphsUnidadesDetailPage implements OnInit {
