...
@Component({
  selector: 'app-vphs-unidad-pac-archivo-detail',
  templateUrl: './vphs-unidad-pac-archivo-detail.page.html',
  styleUrls: ['./vphs-unidad-pac-archivo-detail.page.scss'],
  providers:[AdminService,DataService]

})
export class VphsUnidadPacArchivoDetailPage implements OnInit {
