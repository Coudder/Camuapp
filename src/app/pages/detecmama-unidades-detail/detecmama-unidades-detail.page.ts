...
@Component({
  selector: 'app-detecmama-unidades-detail',
  templateUrl: './detecmama-unidades-detail.page.html',
  styleUrls: ['./detecmama-unidades-detail.page.scss'],
  providers: [DataService,AdminService]
})
export class DetecmamaUnidadesDetailPage implements OnInit {
      ...
      //console.log(this.id);
       this._dataService.getUnidadDetail(this.id).subscribe(
        response => {
          ...
          //obtenemos info del paralelo de deteeciones
