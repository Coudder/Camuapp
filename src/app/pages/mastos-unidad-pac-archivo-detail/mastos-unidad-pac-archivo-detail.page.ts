...
@Component({
  selector: 'app-mastos-unidad-pac-archivo-detail',
  templateUrl: './mastos-unidad-pac-archivo-detail.page.html',
  styleUrls: ['./mastos-unidad-pac-archivo-detail.page.scss'],
  providers:[AdminService,DataService]

})
export class MastosUnidadPacArchivoDetailPage implements OnInit {
