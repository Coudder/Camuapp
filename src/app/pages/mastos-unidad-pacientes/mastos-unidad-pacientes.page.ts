...
@Component({
  selector: 'app-mastos-unidad-pacientes',
  templateUrl: './mastos-unidad-pacientes.page.html',
  styleUrls: ['./mastos-unidad-pacientes.page.scss'],
  providers:[AdminService,DataService]
})
export class MastosUnidadPacientesPage implements OnInit {
