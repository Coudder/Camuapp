...
@Component({
  selector: 'app-detecmama-unidad-pac-archivo',
  templateUrl: './detecmama-unidad-pac-archivo.page.html',
  styleUrls: ['./detecmama-unidad-pac-archivo.page.scss'],
})
export class DetecmamaUnidadPacArchivoPage implements OnInit {
  ...
  constructor(
    ...
    this.title = 'PAC. ARCHIVO EXPL. MAMA'
